...
<body>
    ...
    <div class="menu">
            ...
            <tr>
                ...
                <tr>
                    <td><br><br><br><hr class="hori"></td>
                </tr>
                <tr>
                    <td style="padding:0px 0px 10px" colspan="2">
                        <table border="0" class="profile-container">
                            ...
                            <tr>
                                <td colspan="2"  style="padding:0px;margin:0px;">
                                    <a href="../logout.php" ><input type="button" value="Log out" class="logout-btn btn-primary-soft btn" style ="padding:10px"></a>
                                </td>
                            </tr>
                    </table>
                    </td>
        ...
        <div class="dash-body" style="margin-top: 15px;padding-right:50px;">
        <br>
        <a href="patient.php" ><button  class="login-btn btn-primary-soft btn btn-icon-back"  style="padding-top:11px;padding-bottom:11px;margin-left:20px;width:125px;position:fixed"><font class="tn-in-text">Back</font></button></a>
                    
                        <table class="filter-container" border="0" style =" margin-left: 50%; width:50%" >
                        <tr> 
                        ...
                        <form action="" method="post">
                            ...
                            <input type="date" name="sheduledate" id="date" class="input-text filter-container-items" style="margin: 0;width: 90%;">
